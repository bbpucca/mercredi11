...
# p pseudo.update("Bonjour monde !")



array_of_pseudo = ["@ClrNico", "@justinbieber"]

array_of_pseudo.each do |pseudo|
	client.update(pseudo + " Salut !")
	pseudo[0] = ""
...
# end
	...
	# client.create_direct_message(pseudo, "Bonjour monde !")
